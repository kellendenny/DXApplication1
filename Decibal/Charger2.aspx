<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Charger2.aspx.cs" Inherits="Decibal.WebForm2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table class="dx-justification">
        <tr>
            <td style="text-align: center; font-size: medium; font-weight: bold;" class="dxflEmptyItem_MetropolisBlue" colspan="2">CAR CHARGER NO. 2</td>
            <td style="width: 212px; text-align: center; height: 21px; font-weight: bold; font-size: medium;">ID = 1002</td>
